...
public class HotelReservationSystem {
	...
	public ArrayList<String> findCheapestHotel(String checkIn, String checkOut) {
		...
		addDetail("Lakewood", 110, 90, 3);
		addDetail("Bridgewood", 150, 50, 4);
		addDetail("Ridgewood", 220, 150, 5);
	...
	public void addDetail(String hotelName, int weekDayRate, int weekendRate, int rating) {
