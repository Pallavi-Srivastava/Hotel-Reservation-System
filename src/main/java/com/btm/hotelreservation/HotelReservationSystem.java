...
public class HotelReservationSystem {
	...
	public ArrayList<String> findCheapestHotel(String checkIn, String checkOut) throws ParseException {
		...
		hotelDetails.add(new HotelDetails("Lakewood", 110, 90,3));
		hotelDetails.add(new HotelDetails("Bridgewood", 150, 50,4));
		hotelDetails.add(new HotelDetails("Ridgewood", 220, 150,5));
